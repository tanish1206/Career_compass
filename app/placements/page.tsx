      ...
      <main className="p-6 md:p-8 pt-20 md:pt-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div ref={internshipGridRef} className="grid md:grid-cols-2 gap-6 relative bento-section">
              <GlobalSpotlight
          ...
          <div>
            ...
            <div ref={fullTimeGridRef} className="grid md:grid-cols-2 gap-6 relative bento-section">
              <GlobalSpotlight
